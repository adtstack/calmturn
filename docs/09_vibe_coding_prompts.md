...
- Android 우선 출시를 고려해 접근성, 단순한 UI, Material 기본 동작을 우선한다.
...
## Prompt 12 — Android 마감 품질
```text
Android 출시를 위해 UI와 품질을 다듬어줘.

확인할 것:
- 작은 Android 화면에서도 TimerScreen이 잘 보이는지
